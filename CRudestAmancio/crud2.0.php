...
<head>
    ...
    <link rel="stylesheet" href="crudest.css">
    <title>TEST</title>
</head>
<body>
<div class="container">
  <div class="p">CRUD PHP</div>
<form class="row g-3" action="crud1.0.php" method="POST">
  <div class="col-md-4">
  ...
  <div class="col-md-4">
    <label for="inputCity" class="form-label"><b>Birthdate</b></label>
    <input type="date" name="birth" class="form-control" id="inputCity" required>
  </div>
  <div class="col-md-4">
    <label for="inputZip" class="form-label"><b>Address</b></label>
    ...
    if ($result) 
    {
     ...
     foreach($result as $row) {
      ...
      <tr style="font-size: 15px;">
        ...
        <form action="crud1.0.php" method="POST" style="display:inline;">
            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
            <input type="submit" class="btn btn-danger" name="delete-submit" value="Delete">
          </form>
        </td>
        <!-- Edit Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="crud1.0.php" method="POST">
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                    <div class="mb-3">
